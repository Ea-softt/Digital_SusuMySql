...
export const MOCK_USER_MEMBER: User = {
  ...
  occupation: 'Trader',
  bio: 'Experienced trader in the Accra central market. Looking to save for a new shop.',
...
export const MOCK_USER_ADMIN: User = {
  ...
  occupation: 'Teacher',
  bio: 'Passionate about education and community saving. Leading the circle for 2 years.',
...
export const MOCK_USER_SUPERUSER: User = {
  ...
  bio: 'Main system administrator for the Digital Susu platform.',
